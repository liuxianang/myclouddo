package com.bootdo.clouddoactiviti.config;
...
public class AuthConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        // 排除配置
        addInterceptor.excludePathPatterns("/task/**");
        addInterceptor.excludePathPatterns("/BX/**");
        addInterceptor.excludePathPatterns("/Activiti/**");

        addInterceptor.excludePathPatterns("/ad**");
        // 拦截配置

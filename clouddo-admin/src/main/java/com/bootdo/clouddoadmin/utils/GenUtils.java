...
import com.bootdo.clouddoadmin.config.Constant;
import com.bootdo.clouddoadmin.domain.ColumnDO;
import com.bootdo.clouddoadmin.domain.TableDO;
...
public class GenUtils {
    ...
    public static List<String> getTemplates() {
        ...
        templates.add("generator/list.vue.vm");
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        map.put("columns_VUE", tableDO.getColumns().toString().replaceAll("ColumnDO","").replaceAll("=",":"));
        System.out.println(">>>>>>>>>>>>>>>>>columns"+ tableDO.getColumns().toString().replaceAll("ColumnDO","").replaceAll("=",":"));
...
//		}
        ...
        if (template.contains("list.vue.vm")) {
            return "main" + File.separator + "resources" + File.separator + "components" + File.separator
                     + classname + File.separator + classname + ".vue";
        ...
        if (template.contains("list.js.vm")) {
            return "main" + File.separator + "resources" + File.separator +  "API" + File.separator +"api_" +classname + ".js";

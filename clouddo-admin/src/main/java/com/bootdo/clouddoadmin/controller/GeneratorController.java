...
import com.bootdo.clouddoadmin.service.GeneratorService;
import com.bootdo.clouddoadmin.utils.GenUtils;
...
public class GeneratorController {
	...
	R list(@RequestParam Map<String, Object> params) {
		...
		PageUtils pageUtils = new PageUtils(list.subList(start, end), total);

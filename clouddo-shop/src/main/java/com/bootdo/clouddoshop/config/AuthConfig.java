package com.bootdo.clouddoshop.config;
...
public class AuthConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        addInterceptor.excludePathPatterns("/goods/**");
        addInterceptor.excludePathPatterns("/orderlist/**");
        addInterceptor.excludePathPatterns("/cartlist/**");
        addInterceptor.excludePathPatterns("/addresslist/**");
        // 拦截配置

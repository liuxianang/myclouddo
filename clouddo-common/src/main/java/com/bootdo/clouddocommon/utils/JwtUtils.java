...
public class JwtUtils {
    public static String generateToken(UserToken userToken, int expire) throws Exception {
        String token = Jwts.builder()
                ...
                .claim(CommonConstants.CONTEXT_roleNAME, userToken.getRolenames())
    ...
    public static UserToken getInfoFromToken(String token) throws Exception {
        Claims claims = Jwts.parser()
                ...
                .getBody();
        return new UserToken(claims.getSubject(), claims.get(CommonConstants.CONTEXT_USER_ID).toString(),claims.get(CommonConstants.CONTEXT_NAME).toString(),claims.get(CommonConstants.CONTEXT_roleNAME).toString());
    }
}
